...
// Import PostgresSaver and pg
const { Pool } = pg

// Create Postgres connection pool
const pool = new Pool({
    connectionString: "postgresql://user:password@localhost:5434/testdb", // Update with your connection details
})

// Initialize PostgresSaver
const checkpointer = new PostgresSaver(pool)

// Setup checkpointer tables (only needed first time)
